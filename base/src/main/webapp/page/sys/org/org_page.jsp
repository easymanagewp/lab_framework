...
<body>
	<div class="bar">
		组织列表&nbsp;总记录数: ${pageResult.pageBean.totalRows} (共 ${pageResult.pageBean.totalPages} 页)
	</div>
	...
	<div class="body">
		<form id="listForm" action="page.do" method="post">
			...
			<div class="buttonbar">
	        	<a class="btn pull_right" href="edit.do?pid=${vo.pid}"><i><img src="${stylePath}/images/btn_icon_xinzeng.png"></i>添加</a>
			</div>	
			<table id="listTable" class="listTable">
				...
				<tr>
					...
					<th>
						<a href="javascript:void(0)" class="sort" name="code" hidefocus>编码</a>
					</th>
					<th width="8%">
