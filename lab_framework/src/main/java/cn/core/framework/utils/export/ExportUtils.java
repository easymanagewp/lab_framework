...
public final class ExportUtils {
	...
	public static final String TEMPLATE_PATH = SERVER_BASE + ApplicationUtils.getValue("config.export.template").toString().replace("\\", File.separator);
	public static final String TEMP_PATH = SERVER_BASE +  ApplicationUtils.getValue("config.export.temp").toString().replace("\\", File.separator);
	...
	public static String export(String source,String target,Map<String, Object> beansMaps) throws GlobalException {
		...
		target = TEMP_PATH + File.separator+sourceArrays[0]+"-"+System.currentTimeMillis()+"."+sourceArrays[1];
