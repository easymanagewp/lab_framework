...
public class XMLUtils {
	...
	public static Document readDocument(String classPathLocation){
		InputStream inputStream = FileUtils.loadClassPathFile2Stream(classPathLocation);
		return XMLUtils.readDocument(inputStream);
	}
	...
	public static Map<String, Object> xml2Map(String classPathLocation){  
		Document doc = readDocument(classPathLocation);
