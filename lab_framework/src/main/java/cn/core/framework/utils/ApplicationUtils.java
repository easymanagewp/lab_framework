...
public class ApplicationUtils {
	private static Map<String,Object> config = XMLUtils.xml2Map("config.xml");
	...
	public static Object getValue(String name) {
		...
		Map config = (Map) servletContext.getAttribute(configName);
		JXPathContext jxPath = JXPathContext.newContext(config);
